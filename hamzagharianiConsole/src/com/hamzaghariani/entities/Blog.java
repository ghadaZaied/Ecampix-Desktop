...
public class Blog {
    ...
    private int views_blog;

    public Blog() {
    }

    public Blog(String date_blog, String nom_ut_blog, String titre_blog, String desc_blog, String image_blog, int likes_blog,int views_blog) {
        ...
        this.views_blog = views_blog;
    }

    public Blog(int idBlog, String date_blog, String nom_ut_blog, String titre_blog, String desc_blog, String image_blog, int likes_blog,int views_blog) {
        this.idBlog = idBlog;
        this.date_blog = date_blog;
        this.nom_ut_blog = nom_ut_blog;
        this.titre_blog = titre_blog;
    ...
    public int getViews_blog() {
        return views_blog;
    }

    public void setViews_blog(int views_blog) {
        this.views_blog = views_blog;
    }
