...
public class FrontEcampixController implements Initializable {
    ...
    @FXML
    private AnchorPane singleBlogPane;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        blogs = new ArrayList<>(bc.getBlogs()/*testingBlogs()*/);
        int column = 0;
        int row = 1;
        ...
        try {
            ...
            fxmlLoader.setLocation(getClass().getResource("/ecampix/desktop/view/blogCard.fxml"));
    ...
    public List<Blog> testingBlogs(){
        Blog b1 = new Blog("20-2-2022","Hamza Ghariani","Titre 1","Description 1 lorem ipsmu text view report soraka malphite ok ashe jijnf dsqd","image 1");
    ...
    @FXML
    private void otherButtonPressed(javafx.event.ActionEvent event) {
     if(event.getSource() == otherBtn){
         blogsAnchorPane.setVisible(false);
     }   
     
     if(event.getSource() == blogsBtn){
         blogsAnchorPane.setVisible(true);
     }
    }
